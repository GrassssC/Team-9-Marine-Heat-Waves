mhws_onshore = read.csv("Port_Hacking_onshore_analys.csv",header = TRUE,colClasses=c("numeric","Date","Date","numeric","Date","numeric","numeric","numeric","character","character"))
mhws_offshore = read.csv("Port_Hacking_offshore_analys.csv",header = TRUE,colClasses=c("numeric","Date","Date","numeric","Date","numeric","numeric","numeric","character","character"))
